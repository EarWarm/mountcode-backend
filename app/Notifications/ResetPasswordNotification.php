...
class ResetPasswordNotification extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Данное письмо будет активно в течение :count минут. Если вы не запрашивали это письмо, просто игнорируйте это сообщение.', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.expire')]));
    }
